    ...
    <section className="py-24 md:py-32 px-6 overflow-hidden relative" id="gallery">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 gap-4">
          <div>
            <h2 className="font-script text-5xl md:text-7xl rotate-[-2deg] inline-block">Galeria</h2>
                ...
                >
                  <div className={`relative gig-poster overflow-visible ${idx % 2 === 0 ? 'rotate-[-3deg]' : 'rotate-[3deg]'} 
                    ...
                    <div className="p-4 bg-white text-black">
                      <h3 className="font-marker text-xl uppercase tracking-tighter truncate">{image.title || ''}</h3>
                      <p className="font-hand text-sm opacity-70 truncate">{image.description || ''}</p>
                    </div>
