...
export const pricingConfig: PricingItem[] = [
  ...
  {
    title: "3 horas",
    description: "Para quem quer treinar músicas novas",
    price: "90",
    originalPrice: "120",
    highlight: true,
  },
  {
    title: "4 horas",
    description: "Para ensaiar a performance completa",
    price: "120",
    originalPrice: "140",
  }
];
...
export const importantNotices = [
  "Agendamentos devem ser feitos com até <strong>12hs de antecedência</strong> do horário proposto para o ensaio.",
