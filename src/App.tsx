    ...
    <div className="antialiased selection:bg-studioOrange selection:text-black">
      <header className="fixed top-0 left-0 w-full z-[100] p-6 pointer-events-none">
        <div className="max-w-7xl mx-auto flex justify-between items-start">
          <div className="pointer-events-auto">
            ...
            <div className="bg-white text-black p-2 font-marker rotate-[-2deg] border-2 border-black shadow-xl">
              <Logo gap="gap-6" iconHeight="h-15" labHeight="h-10" />
              <div className="text-[18px] text-center mt-1 border-t border-black uppercase">{randomPhrase}</div>
            </div>
          </div>
          <nav className="pointer-events-auto flex flex-wrap gap-4 items-center">
            <a className="font-script text-white hover:text-studioOrange text-2xl px-3 py-1 rotate-[-3deg]" href="#about">Quem Somos</a>
            <a className="font-script text-white hover:text-studioOrange text-2xl px-3 py-1 rotate-[2deg]" href="#services">O Que Rola</a>
            <a className="font-script text-white hover:text-studioOrange text-2xl px-3 py-1 rotate-[-1deg]" href="#gallery">Fotos</a>
            <a className="font-script text-white hover:text-studioOrange text-2xl px-3 py-1 rotate-[3deg]" href="#calendar">Agenda</a>
            <a className="bg-studioOrange text-black font-marker px-6 py-2 rotate-[-1deg] hover:scale-110 transition-transform shadow-lg border-2 border-black" href="#contact">RESERVA!</a>
          </nav>
        </div>
      </header>
      ...
      <main className="relative">
        <section className="min-h-screen flex items-center justify-center p-6" id="home">
          <div className="relative w-full max-w-5xl">
            ...
            <div className="relative z-10 border-4 border-dashed border-white/20 p-12 md:p-20 rounded-3xl bg-black/40 backdrop-blur-sm">
              ...
              <h1 className="font-script text-6xl md:text-[9rem] leading-[0.8] text-center uppercase tracking-tighter mb-8">
                ELEVE SEU <br />
              ...
              <div className="flex flex-col md:flex-row items-center gap-12 mt-12">
                <div className="flex-1">
                  <p className="font-hand text-2xl md:text-3xl leading-snug">
        ...
        <section className="py-32 px-6" id="about">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            <div className="relative">
              <div className="font-script text-7xl text-studioOrange mb-8 rotate-[-2deg]">O que é o Lab 73?</div>
              <div className="space-y-6 text-3xl font-hand">
        ...
        <section className="py-32 px-6" id="services">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-24">
              <h2 className="font-script text-8xl inline-block border-b-8 border-studioOrange pb-4 rotate-1">O QUE ROLA</h2>
            </div>
        ...
        <section className="py-32 px-6 overflow-hidden" id="gallery">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
              <h2 className="font-script text-7xl rotate-[-2deg]">Gig Poster & Flyer Collection</h2>
              <p className="font-hand text-xl text-studioOrange max-w-xs text-right italic">Memórias de palco coladas no fanzine</p>
            </div>
        ...
        <section className="py-32 px-6" id="pricing">
          <div className="max-w-4xl mx-auto torn-paper notebook-paper p-12 md:p-20 shadow-[20px_20px_0px_#f97316] rotate-1 relative">
            ...
            <h2 className="font-script text-7xl mb-16 text-center underline decoration-studioOrange decoration-8 underline-offset-8 uppercase">TABELA DE PREÇO$</h2>
            <div className="space-y-10 font-hand text-2xl">
              {pricingPlans.map((p, i) => (
                <div key={i} className={`${p.highlight ? 'bg-studioOrange/20 p-6 border-4 border-double border-studioOrange rotate-[-1deg]' : 'border-b-2 border-black/10 pb-4'} flex justify-between items-center`}>
                  <div>
                    <div className={`font-marker text-3xl uppercase ${p.highlight ? 'text-studioOrange' : ''}`}>{p.title}</div>
                    <div className="text-black/60">{p.desc}</div>
                  </div>
                  <div className={`font-marker ${p.highlight ? 'text-6xl' : 'text-5xl text-studioOrange'}`}>{p.price}</div>
                </div>
              ))}
            </div>
            <div className="mt-12 text-center">
              <span className="inline-block border-4 border-red-600 text-red-600 px-6 py-2 font-marker text-2xl rotate-[-3deg] uppercase font-bold">Vagas Limitadas</span>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="whiteboard-grid p-8 shadow-2xl relative rotate-[-1deg]">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center mb-10">
                <h2 className="font-marker text-4xl text-black flex items-center gap-3">
                  <span className="material-symbols-outlined text-studioOrange !text-4xl">calendar_month</span>
        ...
        <section className="py-20 px-6" id="connect">
          <div className="max-w-4xl mx-auto border-4 border-dashed border-white/10 p-12 rounded-[50px] relative bg-zinc-900/30 backdrop-blur-sm shadow-2xl">
            ...
            <div className="text-center mb-16">
              <h2 className="font-hand text-5xl md:text-6xl text-studioOrange">
        ...
        <section className="py-32 px-6" id="contact">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            <div className="lg:w-1/3 torn-paper torn-edge-aggressive notebook-paper p-10 rotate-[-2deg] shadow-2xl relative z-10">
              ...
              <h2 className="font-script text-6xl mb-12 border-b-4 border-black uppercase">CONTATO</h2>
              <div className="space-y-10 font-hand text-2xl">
                <div>
      ...
      <footer className="py-20 px-6 relative border-t border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="text-center font-hand text-2xl">
            <p className="font-marker text-3xl mb-4">© 2025 ESTÚDIO LAB73</p>
            <p className="opacity-50">Feito para o som que ressoa no peito.</p>
          </div>
        </div>
